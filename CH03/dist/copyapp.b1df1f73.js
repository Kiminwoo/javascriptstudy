...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"copyapp.js":[function(require,module,exports) {
var container = document.getElementById('root');
var content = document.createElement('div');
var ajax = new XMLHttpRequest();
var NEWS_URL = 'https://api.hnpwa.com/v0/news/1.json'; // 뉴스 피드 

var CONTENT_URL = 'https://api.hnpwa.com/v0/item/@id.json'; // 뉴스 내용 
...
function router() {
  // 라우터 함수 
  var routePath = location.hash; // 주소값으로 라우터 처리  

  if (routePath === '') {
    // location.hash 에 #만 있을 경우 빈문자열로 
    newsFeed();
...
},{}]},{},["../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","copyapp.js"], null)
//# sourceMappingURL=/copyapp.b1df1f73.js.map